  ...
  private async executeTool(toolCall: any): Promise<any> {
    ...
    switch (toolName) {
      ...
      case 'findPersonByName':
        ...
        console.log(
          `[SEARCH] Searching for "${searchName}" in caches:`,
          cacheKeysToSearch,
        );
        ...
        if (allExactMatches.length === 0 && allSimilarMatches.length === 0) {
          ...
          try {
            ...
            console.log(
              '[SEARCH] Not a coordinator or error fetching students:',
              error.message,
            );
          }
      ...
      case 'generateReport':
        ...
        this.cacheService.set(
          ...
          3600000,
        ); // 1 hora de TTL para dar tempo de clicar no link
