...
// Configuração
const API_URL = 'http://localhost:3001/chat/test_closed';
...
class InteractiveChatTester {
  ...
  async start(): Promise<void> {
    console.log('\n' + '='.repeat(80));
    console.log('🤖 CHAT INTERATIVO - FLUXO CLOSED RADE (TESTE)');
    ...
    console.log('   - Este fluxo NÃO possui opção de IA, apenas vídeos e transferência\n');
    console.log('='.repeat(80) + '\n');
